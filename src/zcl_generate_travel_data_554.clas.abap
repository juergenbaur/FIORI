CLASS zcl_generate_travel_data_554 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_554 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_554.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_554.

*   insert the new table entries
    INSERT ztravel_554 FROM TABLE @itab.
